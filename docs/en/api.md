...
| padding    | Similar CSS padding. You can specifically `up` `right` `bottom` `left` by an array of numbers. such as `[0, 10, 20, n => n + 30]` | -        | `Number | Array<Number | Function>` | 8                                                                                 |
| bound      | Specify low and high points on the Y axis. such as `[0, 100]` or `[n => n - 100, n => n + 100]`                                   | -        | `Array<Number | Function>`          | -                                                                                 |
| narrow     | Leave width on both sides of the X axis. If ture, the value is half the x scale. [example](narrow)                                | -        | `Boolean | Number | Function`       | -                                                                                 |
